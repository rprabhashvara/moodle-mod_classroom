...
class mod_classroom_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('classroomname', 'mod_classroom'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'classroomname', 'mod_classroom');
        ...
        $year = $now->format('Y');
        $mform->addElement('date_time_selector', 'time', get_string('classroomtime', 'mod_classroom'),
